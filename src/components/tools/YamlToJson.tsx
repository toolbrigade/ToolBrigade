...
export default function YamlToJson() {
  ...
  async function convert() {
    ...
    try {
      ...
      trackTaskComplete("yaml-to-json", startTime);
    } catch { setError("Invalid YAML. Please check your input."); }
  }
    ...
    <div className="space-y-4">
      <div className="grid md:grid-cols-2 gap-4">
        <div className="space-y-1">
          <label className="text-sm font-medium text-[var(--text)]">YAML Input</label>
